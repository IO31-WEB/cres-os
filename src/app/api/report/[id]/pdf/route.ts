...
// Vercel's function runtime doesn't set any of those, so we spoof the env
// var so the library's own detection extracts the al2023 (Node 20+) build,
// and mirror its LD_LIBRARY_PATH setup so the dynamic linker finds it.
